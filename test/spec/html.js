...
describe("html:", () => {
  ...
  it("throws for implicit usage of style element in nested template", () => {
    const render = html` <div>${html` <style></style> `}</div> `;
  ...
  it("throws for implicit usage of inline styles in nested template", () => {
    const render = html`
      <div>${html`<div></div>`.css`div { color: red }`}</div>
    `;
