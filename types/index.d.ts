...
export namespace router {
  ...
  /**
   * Navigates to the view programmatically, as if the user clicked an anchor
   * with the URL generated by `router.url()`. Throws if the root router is not
   * connected, the view is not a part of the router, or the router is
   * currently dispatching the `navigate` event.
   *
   * @param view - a view definition
   * @param params - parameters passed to the view, plus the `scrollToTop`
   *   option
