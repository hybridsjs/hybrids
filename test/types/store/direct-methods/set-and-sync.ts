...
const primitivesInUpdateNestedModels = {
  ...
  nestedSingleton: { ...primitives },
  optionalNestedSingleton: { ...primitives },
  nestedEnumerables: [{ id: "1", ...primitives }, { id: "1", ...primitives }]
}
...
const emptyInUpdateNestedModels = {
  ...
  nestedSingleton: { ...empty },
  optionalNestedSingleton: { ...empty },
  nestedEnumerables: [{ id: "1", ...empty }, { id: "1", ...empty }]
}
...
const refsInUpdateNestedModels = {
  ...
  nestedSingleton: { ...refs },
  optionalNestedSingleton: { ...refs },
  nestedEnumerables: [{ id: "1", ...refs }, { id: "1", ...refs }]
}
...
const identifiersInUpdateNestedModels = {
  ...
  nestedSingleton: { ...identifiers },
  optionalNestedSingleton: { ...identifiers },
  nestedEnumerables: [{ id: "1", ...identifiers }, { id: "1", ...identifiers }]
}
...
const unrefsInUpdateNestedModels = {
  ...
  nestedSingleton: { ...unrefs },
  optionalNestedSingleton: { ...unrefs },
  nestedEnumerables: [{ id: "1", ...unrefs }, { id: "1", ...unrefs }]
}
...
const collisionsInUpdateNestedModels = {
  ...
  nestedSingleton: { ...collisions },
  optionalNestedSingleton: { ...collisions },
  nestedEnumerables: [{ id: "1", ...collisions }, { id: "1", ...collisions }]
}
...
// Overload via Definition
{
  // Create...
  {
    ...
    {
      // ...set primitive propertiers
      enumerablePromiseInput = store.set(Enumerable, primitivesInCreateNestedModels)
      ...
      // ...binding through identifiers
      enumerablePromiseInput = store.set(Enumerable, identifiersInCreateNestedModels)
      enumerableInput = store.sync(Enumerable, identifiersInCreateNestedModels)

      // ...unbinding
      enumerablePromiseInput = store.set(Enumerable, unrefsInCreateNestedModels)
      enumerableInput = store.sync(Enumerable, unrefsInCreateNestedModels)

      // ...check collisions
      /// @ts-expect-error
      enumerablePromiseInput = store.set(Enumerable, collisionsInCreateNestedModels)
      /// @ts-expect-error
  ...
  // Update...
  {
    ...
    {
      // ...set primitive propertiers
      singletonPromiseInput = store.set(Singleton, primitivesInUpdateNestedModels)
      singletonInput = store.sync(Singleton, primitivesInUpdateNestedModels)
      enumerablePromiseInput = store.set(Enumerable, { id: "1", ...primitivesInUpdateNestedModels })
      enumerableInput = store.sync(Enumerable, { id: "1", ...primitivesInUpdateNestedModels })
      ...
      enumerablePromiseInput = store.set(Enumerable, { id: "1", ...emptyInUpdateNestedModels })
      enumerableInput = store.sync(Enumerable, { id: "1", ...emptyInUpdateNestedModels })
      ...
      enumerablePromiseInput = store.set(Enumerable, { id: "1", ...refsInUpdateNestedModels })
      enumerableInput = store.sync(Enumerable, { id: "1", ...refsInUpdateNestedModels })

      // ...binding through identifiers
      singletonPromiseInput = store.set(Singleton, identifiersInUpdateNestedModels)
      singletonInput = store.sync(Singleton, identifiersInUpdateNestedModels)
      enumerablePromiseInput = store.set(Enumerable, { id: "1", ...identifiersInUpdateNestedModels })
      ...
      enumerablePromiseInput = store.set(Enumerable, { id: "1", ...unrefsInUpdateNestedModels })
      enumerableInput = store.sync(Enumerable, { id: "1", ...unrefsInUpdateNestedModels })

      // ...check collisions
      /// @ts-expect-error
      singletonPromiseInput = store.set(Singleton, collisionsInUpdateNestedModels)
      /// @ts-expect-error
      singletonInput = store.sync(Singleton, collisionsInUpdateNestedModels)
      /// @ts-expect-error
      enumerablePromiseInput = store.set(Enumerable, { id: "1", ...collisionsInUpdateNestedModels })
      /// @ts-expect-error
      enumerableInput = store.sync(Enumerable, { id: "1", ...collisionsInUpdateNestedModels })
    }
  }
  ...
  // Mixed...
  {
    ...
    {
      // ...set primitive propertiers
      enumerablePromiseInput = store.set(Enumerable, primitivesInUpdateNestedModels)
      ...
      // ...binding through identifiers
      enumerablePromiseInput = store.set(Enumerable, identifiersInUpdateNestedModels)
      enumerableInput = store.sync(Enumerable, identifiersInUpdateNestedModels)

      // ...unbinding
      enumerablePromiseInput = store.set(Enumerable, unrefsInUpdateNestedModels)
      enumerableInput = store.sync(Enumerable, unrefsInUpdateNestedModels)

      // ...check collisions
      /// @ts-expect-error
      enumerablePromiseInput = store.set(Enumerable, collisionsInUpdateNestedModels)
      /// @ts-expect-error
    ...
    {
      // ...set primitive propertiers
      singletonPromiseInput = store.set(Singleton, primitivesInCreateNestedModels)
      singletonInput = store.sync(Singleton, primitivesInCreateNestedModels)
      enumerablePromiseInput = store.set(Enumerable, { id: "1", ...primitivesInCreateNestedModels })
      enumerableInput = store.sync(Enumerable, { id: "1", ...primitivesInCreateNestedModels })
      ...
      enumerablePromiseInput = store.set(Enumerable, { id: "1", ...emptyInCreateNestedModels })
      enumerableInput = store.sync(Enumerable, { id: "1", ...emptyInCreateNestedModels })
      ...
      enumerablePromiseInput = store.set(Enumerable, { id: "1", ...refsInCreateNestedModels })
      enumerableInput = store.sync(Enumerable, { id: "1", ...refsInCreateNestedModels })

      // ...binding through identifiers
      singletonPromiseInput = store.set(Singleton, identifiersInCreateNestedModels)
      singletonInput = store.sync(Singleton, identifiersInCreateNestedModels)
      enumerablePromiseInput = store.set(Enumerable, { id: "1", ...identifiersInCreateNestedModels })
      enumerableInput = store.sync(Enumerable, { id: "1", ...identifiersInCreateNestedModels })
      ...
      enumerablePromiseInput = store.set(Enumerable, { id: "1", ...unrefsInCreateNestedModels })
      enumerableInput = store.sync(Enumerable, { id: "1", ...unrefsInCreateNestedModels })

      // ...check collisions
      /// @ts-expect-error
      singletonPromiseInput = store.set(Singleton, collisionsInCreateNestedModels)
      /// @ts-expect-error
      singletonInput = store.sync(Singleton, collisionsInCreateNestedModels)
      /// @ts-expect-error
      enumerablePromiseInput = store.set(Enumerable, { id: "1", ...collisionsInCreateNestedModels })
      /// @ts-expect-error
      enumerableInput = store.sync(Enumerable, { id: "1", ...collisionsInCreateNestedModels })
    }
  }
}
